...
export function initLights(scene) {
    ...
    // const spotLightHelper1 = new THREE.SpotLightHelper(sun);
    // const spotLightHelper2 = new THREE.SpotLightHelper(l);

    var light2 = new THREE.HemisphereLight(0xffffff, 0x999999, 0.5);

    [sun, l, light2].map(l => scene.add(l));
    // [spotLightHelper1, spotLightHelper2].map(spotLightHelper1 => scene.add(spotLightHelper1));
}
